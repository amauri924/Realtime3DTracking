...
from utils.utils_3dcent import *
...
#            with open("debug_"+str(x.device)+".txt",'a') as f:
#                f.write("computed base"+"\n")
...
#                f.write("b"+str(b)+"\n")
            ...
            del b,roi
#            with open("debug_"+str(x.device)+".txt",'a') as f:
#                f.write("computed pooling"+"\n")
#                f.write("pooled_features"+str(pooled_features)+"\n")
            pooled_features=self.top_layer(pooled_features) # Run the final layers 
            
#            with open("debug_"+str(x.device)+".txt",'a') as f:
#                f.write("computed top"+"\n")
                
            center_pred=self.center_prediction(pooled_features)/100 # Run the 3D prediction
            
#            with open("debug_"+str(x.device)+".txt",'a') as f:
#                f.write("computed center pred"+"\n")
            

#            with open("debug_"+str(features.device)+".txt",'a') as f:
#                f.write("pred_0_shape:"+str(p[0].shape)+'\n')
#                f.write("pred_1_shape:"+str(p[1].shape)+'\n')
#                f.write("pred_2_shape:"+str(p[2].shape)+'\n')
#                f.write("pred_0_device:"+str(p[0].device)+'\n')
#                f.write("pred_1_device:"+str(p[1].device)+'\n')
#                f.write("pred_2_device:"+str(p[2].device)+'\n')
#                f.write("pred_center_shape:"+str(center_pred.shape)+'\n')
#                f.write("pred_center_device:"+str(center_pred.device)+'\n')
#                f.write("pred_0_shape:"+str(io_orig[0].shape)+'\n')
#                f.write("pred_1_shape:"+str(io_orig[1].shape)+'\n')
#                f.write("pred_2_shape:"+str(io_orig[2].shape)+'\n')
#                f.write("pred_0_device:"+str(io_orig[0].device)+'\n')
#                f.write("pred_1_device:"+str(io_orig[1].device)+'\n')
#                f.write("pred_2_device:"+str(io_orig[2].device)+'\n')
#                f.write("======================================================\n")
